...
const managers = [
  { name: 'npm', command: 'npm create bubbles@latest', color: '#cb3837', mark: 'n' },
  { name: 'yarn', command: 'yarn create bubbles', color: '#2c8ebb', mark: 'y' },
  { name: 'pnpm', command: 'pnpm create bubbles@latest', color: '#e7a528', mark: 'p' },
  { name: 'bun', command: 'bun create bubbles@latest', color: '#ac8767', mark: 'b' },
]
