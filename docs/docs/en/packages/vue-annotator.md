...
<template>
  <div :class="{ 'dark-theme': isDark }">
    <Annotator :text="text" :entities="entities" :entity-labels="entityLabels" :dark="isDark" />
  </div>
</template>
```
...
```vue
<template>
  <Annotator :text="arabicText" :entities="entities" :entity-labels="entityLabels" :rtl="true" />
</template>
```
